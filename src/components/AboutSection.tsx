      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-16 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8 items-stretch">
            {/* Education */}
            <div className="md:col-span-2 text-start lg:col-span-1 bg-theme-card text-theme-card-fg rounded-2xl p-6 shadow-lg border border-theme-border flex flex-col h-full">
            ...
            {/* Tech Toolbox */}
            <div className="md:col-span-3 lg:col-span-2 bg-theme-card text-start text-theme-card-fg rounded-2xl p-6 shadow-lg border border-theme-border flex flex-col h-full overflow-hidden">
              <h3 className="text-xl font-semibold mb-2">Tech Toolbox</h3>
              <p className="text-sm text-neutral-400 leading-relaxed text-theme-muted-fg mb-6">
              ...
              >
                {hobbies.map((hobby) => (
                  <motion.div
                    ...
                    dragElastic={0.15}
                    whileTap={{ scale: 0.95 }}
                    className="absolute inline-flex items-center gap-2 px-4 py-1.5 sm:px-5 sm:py-2 bg-neutral-800/80 border border-white/10 text-white rounded-full  text-xs sm:text-sm font-medium shadow-md cursor-grab active:cursor-grabbing select-none"
